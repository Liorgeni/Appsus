...
export function EmailSideNav({onChangeFilterType}) {
    ...
    <Link to='/mail/compose'>
                   ...
                   <Link onClick={()=> onChangeFilterType('inbox')} to='/mail' className="side-nav-btn"><span className='flex align-center selected'><span class='material-symbols-outlined'>inbox</span>Inbox</span></Link>
